...
class GithubSpider(scrapy.Spider):
    ...
    def parse_repo_info(self, response):
      ...
      github_item_loader.default_output_processor = TakeFirst()
      category = response.request.headers.get('Referer', None).split('/')[-1]
      ...
      github_item_loader.add_xpath('start', "normalize-space(//body//div[4]//div[1]//div[@id = 'js-repo-pjax-container']//div[1]//ul[@class='pagehead-actions']/li[2]//a[@class='social-count js-social-count']//text())")
      github_item_loader.add_xpath('fork', "normalize-space(//body//div[4]//div[1]//div[@id = 'js-repo-pjax-container']//div[1]//ul[@class='pagehead-actions']/li[3]//a[@class='social-count']//text())")
      github_item_loader.add_value('url', response.request.url)
